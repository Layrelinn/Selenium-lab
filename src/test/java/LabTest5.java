...
public class LabTest5 {
    ...
    public void Tests() {
        ...
        new Select(driver.findElement(By.xpath("//select[@id='select-demo']"))).selectByVisibleText("Friday");
        WebElement result = driver.findElement(By.xpath("//p[text()='Day selected :- Friday']"));
